...
class ArticleFrontController extends AbstractController
{
     ...
     */
    public function index(GenderRepository $genderRepository, CategoryRepository $categoryRepository, Article $article, SiteNameRepository $siteNameRepository, HeadShopRepository $headShopRepository): Response
    {
